...
//
//    using ParkPlannerNPSParks;
//
//    var parks = Parks.FromJson(jsonString);

namespace ParkPlannerNPSParks
{
    using System;
    ...
    public partial class Parks
    {
        public static Parks FromJson(string json) => JsonConvert.DeserializeObject<Parks>(json, ParkPlannerNPSParks.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Parks self) => JsonConvert.SerializeObject(self, ParkPlannerNPSParks.Converter.Settings);
    }
